...
We showed experimentally that two assumptions of the our model (\secref{assumptions}) are indeed true: the learned representations are sparse (\figref{sparse_representations}) and structured.
