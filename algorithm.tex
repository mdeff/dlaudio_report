...
This chapter presents our structuring auto-encoder. \secref{hypothesizes} states the hypothesizes our proposed model is built on and \secref{sparse_coding} starts its construction with sparse coding as a base. \secref{dictionary_learning} introduces a trainable dictionary while \secref{manifold_learning} introduces a manifold learning term. Last but not least, \secref{encoder} introduces the trainable encoder. Finally, \secref{energy_formulation} reviews the whole energy-based formulation and brings some new insights.
