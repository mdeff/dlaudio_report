...
The idea is to iteratively solve \eqnref{minZ}, \eqnref{minD} and \eqnref{minE}, i.e. to minimize the objective for one variable at a time while fixing the two others.
...
Sub-problem \eqnref{minZ} is split in a smooth and non-smooth part:
\begin{equation}
